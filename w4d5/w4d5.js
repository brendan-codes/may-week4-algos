...
// 3
let match3 = w => w.filter(w1 => w.some(w2 => w2.includes(w1) && w2 !== w1));

console.log(match3(["mass","as","hero","superhero", "super", "apple", "aosd", "nhiaush"
, "di", "uabs", "igba", "sidais", "d", "nlias", "ig", "su", "her"]));
